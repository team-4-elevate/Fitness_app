...
void main() {
  ...
  setUp(() {
    ...
    provideDummy<ApiResult<List<DifficultyLevelEntity>>>(const ApiSuccess<List<DifficultyLevelEntity>>([]));
    provideDummy<ApiResult<List<ExerciseEntity>>>(const ApiSuccess<List<ExerciseEntity>>([]));
  });
  ...
  group('ExercisePageBloc', () {
    ...
    blocTest<ExercisePageBloc, ExercisePageState>(
      ...
      expect: () => [
        ...
        ExercisePageState(
          ...
          levelExerciseMap: {for (var level in mockLevels) level: <ExerciseEntity>[]},
    ...
    blocTest<ExercisePageBloc, ExercisePageState>(
      ...
      build: () {
        when(mockGetExercisesUseCase('muscle1', 'level1', page: 1))
      ...
      act: (bloc) => bloc.add(const GetExercisesEvent(
        levelId: 'level1',
    ...
    blocTest<ExercisePageBloc, ExercisePageState>(
      ...
      build: () {
        when(mockGetExercisesUseCase('muscle1', 'level1', page: 2))
            .thenAnswer((_) async => ApiSuccess(mockExercises));
        return bloc;
      },
      seed: () => ExercisePageState(
      ...
      act: (bloc) => bloc.add(const LoadMoreExercisesEvent(
        levelId: 'level1',
        muscleGroupId: 'muscle1',
      )),
      expect: () => [
    ...
    blocTest<ExercisePageBloc, ExercisePageState>(
      ...
      build: () {
        when(mockGetExercisesUseCase('muscle1', 'level1', page: 2))
            .thenAnswer((_) async => const ApiFailure('Failed to load more exercises'));
        return bloc;
      },
      seed: () => ExercisePageState(
        getLevelsStatus: Status.success,
    ...
    blocTest<ExercisePageBloc, ExercisePageState>(
      ...
      build: () => bloc,
      act: (bloc) => bloc.add(const ShowYoutubeVideoEvent(
    ...
    blocTest<ExercisePageBloc, ExercisePageState>(
      ...
      build: () {
        when(mockGetExercisesUseCase('muscle1', 'level2', page: 1))
    ...
    blocTest<ExercisePageBloc, ExercisePageState>(
      ...
      act: (bloc) => {
        bloc.add(const GetExercisesEvent(
          levelId: 'level1',
          muscleGroupId: 'muscle1',
          page: 1,
          showLoading: true,
    ...
    blocTest<ExercisePageBloc, ExercisePageState>(
      ...
      expect: () => [
        const ExercisePageState(
          shouldShowYoutubeVideo: true,
          currentVideoLink: 'https://www.youtube.com/watch?v=abc123&feature=share',
        ),
      ],
    );
  });
