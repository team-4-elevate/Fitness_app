...
class _HomeState extends State<Home> {
  ...
  void initState() {
    super.initState();
    // userData = context.read<e>().state.cachedUserData;
  ...
  Widget build(BuildContext context) {
    final userData = context.watch<AppBloc>().state.cachedUserData;
    return Scaffold(
      body: Stack(
        children: [
          Container(
                                    ...
                                    if (index < data.workoutsByGroup.length) {
                                      Navigator.pushNamed(
                                        ...
                                        arguments: ExercisePageArguments(
                                          ...
                                          muscleGroupName:
                                              data.workoutsByGroup[index].name,
                                          muscleGroupImage:
                                              data.workoutsByGroup[index].image,
                                        ),
                                      );
                                    }
                                  },
