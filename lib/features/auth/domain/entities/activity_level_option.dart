...
class ActivityLevelOption {
  ...
  static List<ActivityLevelOption> getActivityLevelOptions({required AppLocalizations localization}) {
    return [
      ...
      ActivityLevelOption(id: 'level3', label: localization.activityIntermediate),
